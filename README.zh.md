...
0.4.32 已从 npm 注册表安装到 DSH Desktop 2.0.10 profile 并完成回归：普通对话可正常响应，复杂集体任务的四个阶段均成功完成，实测推理等级为 `high / high / high / xhigh`。路由器也支持按模型能力选择 `low / medium / high / xhigh / max` 等等级；具体可选项以宿主适配器公布的能力为准。GitHub Release 附带与 npm 包逐字节一致的 tarball，SHA-256 为 `d13b1864b591c784a6f4577278290262a1f51ae8c22239605e8c69018d7c7b4f`。
...
- **ModLens**：负责兼容路由的图片理解，参考 [`liustack/modlens`](https://github.com/liustack/modlens)。
